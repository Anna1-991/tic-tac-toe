...
selectBtnX = container.querySelector(".playerX");
selectBtnO = container.querySelector(".playerO");
playBoard = document.querySelector(".play_board");
allBox = document.querySelectorAll("section span");
const players = document.querySelector(".players");
resultBox = document.querySelector(".result_box"),
wonText = resultBox.querySelector(".win_text"),
replayBtn = resultBox.querySelector("button");

window.onload = () => {
    for (let i = 0; i < allBox.length; i++) {//add onclick attribute in all section's spans
...
let playerXIcon = "fas fa-times"; //fontawesom icon X
let playerOIcon = "fas fa-circle"; //fontawesom icon O
let playerSign = "X";
let runBot = true;
